...
public class Originator {
    ...
    public Originator(int dadoInfanteria, int dadoArtillero, int dadoTanque, int dadoMovimiento1, int dadoMovimiento2, int dadoMovimiento3, int dadoMovimiento4, int dadoMovimiento5, int dadoMovimiento6, int dadoAtaque, int ataqueEspecial) {
    ...
    public void setMemento(Memento m) {
        this.dadoInfanteria=m.getDadoInfanteria();
        this.dadoArtillero=m.getDadoArtillero();
        this.dadoTanque=m.getDadoTanque();
        this.dadoMovimiento1=m.getDadoMovimiento1();
        this.dadoMovimiento2=m.getDadoMovimiento2();
        this.dadoMovimiento3=m.getDadoMovimiento3();
        this.dadoMovimiento4=m.getDadoMovimiento4();
        this.dadoMovimiento5=m.getDadoMovimiento5();
        this.dadoMovimiento6=m.getDadoMovimiento6();
        this.dadoAtaque=m.getDadoAtaque();
        this.ataqueEspecial=m.getAtaqueEspecial();
    }
    // ---------------------------
    public Memento createMemento() {
        return new Memento(dadoInfanteria, dadoArtillero,dadoTanque,dadoMovimiento1,dadoMovimiento2,dadoMovimiento3,dadoMovimiento4,dadoMovimiento5,dadoMovimiento6,dadoAtaque,ataqueEspecial);
    }
