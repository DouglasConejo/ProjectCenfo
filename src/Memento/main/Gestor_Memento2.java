...
public class Gestor_Memento2 {

    private Originator Creador;
    private Caretaker Vigilante;

    public Gestor_Memento2(int dadoInfanteria, int dadoArtillero, int dadoTanque, int dadoMovimiento1, int dadoMovimiento2, int dadoMovimiento3, int dadoMovimiento4, int dadoMovimiento5, int dadoMovimiento6, int dadoAtaque,int dadoAtaqueEspecial) {
        Creador = new Originator(dadoInfanteria, dadoArtillero,dadoTanque,dadoMovimiento1,dadoMovimiento2,dadoMovimiento3,dadoMovimiento4,dadoMovimiento5,dadoMovimiento6,dadoAtaque,dadoAtaqueEspecial);
