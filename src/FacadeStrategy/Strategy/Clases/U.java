...
public class U extends AbstractPrefa {
    @Override
    ...
    public boolean validateShape(int forma, String columna, int renglon, String color) {
        ...
        switch (forma) {
            case 1 -> {
                if (getColorCasilla(columna, renglon+1).equalsIgnoreCase(color) || // 1 ab
                ...
                getColorCasilla(sumaRestaLetras(columna, -1), renglon-2).equalsIgnoreCase(color) || //1 iz-2 arriba
                ...
                getColorCasilla(sumaRestaLetras(columna, 1), renglon-2).equalsIgnoreCase(color)){ //1 der-2 arriba
                    caminoConectado = true;
                }
                if (renglon > 0 && (!columna.equals("A") && !columna.equals("T"))) {
            ...
            case 2 -> {
                ...
                getColorCasilla(sumaRestaLetras(columna, 1), renglon-2).equalsIgnoreCase(color) || // 1 der-2arriba
                getColorCasilla(sumaRestaLetras(columna, 1), renglon+2).equalsIgnoreCase(color) || // 1 der-2 abajo
                getColorCasilla(sumaRestaLetras(columna, 2), renglon-1).equalsIgnoreCase(color) || // 2 der-1 arriba
                getColorCasilla(sumaRestaLetras(columna, 2), renglon+1).equalsIgnoreCase(color)){// 2 der-1 abajo
                    caminoConectado = true;
                }
                if ((renglon > 0 && renglon < 19) && !columna.equals("T")) {
            ...
            case 3 -> {
                if (getColorCasilla(columna, renglon-1).equals(color) || // 1 arriba
                getColorCasilla(sumaRestaLetras(columna, -1), renglon-1).equalsIgnoreCase(color) || // arriba-iz
                ...
                getColorCasilla(sumaRestaLetras(columna, -2), renglon+1).equalsIgnoreCase(color) || //2 iz-1 abajo
                getColorCasilla(sumaRestaLetras(columna, 2), renglon+1).equalsIgnoreCase(color) || // 2 der-1 abajo
                getColorCasilla(sumaRestaLetras(columna, -1), renglon+2).equalsIgnoreCase(color) || // 1 iz-2 abajo
                getColorCasilla(sumaRestaLetras(columna, 1), renglon+2).equalsIgnoreCase(color)){ //1 der-2 abajo
                    caminoConectado = true;
                }
                if (renglon < 19 && (!columna.equals("A") && !columna.equals("T"))) {
                    if (getColorCasilla(sumaRestaLetras(columna, -1), renglon).equalsIgnoreCase("White") &&
                    getColorCasilla(sumaRestaLetras(columna, -1), renglon+1).equalsIgnoreCase("White") &&
                    getColorCasilla(sumaRestaLetras(columna, 1), renglon).equalsIgnoreCase("White") &&
                    getColorCasilla(sumaRestaLetras(columna, 1), renglon+1).equalsIgnoreCase("White") &&
            ...
            case 4 -> {
                ...
                getColorCasilla(sumaRestaLetras(columna, -1), renglon-2).equalsIgnoreCase(color) || // 1 iz-2arriba
                getColorCasilla(sumaRestaLetras(columna, -1), renglon+2).equalsIgnoreCase(color) || // 1 iz-2 abajo
                getColorCasilla(sumaRestaLetras(columna, -2), renglon-1).equalsIgnoreCase(color) || // 2 iz-1 arriba
                getColorCasilla(sumaRestaLetras(columna, -2), renglon+1).equalsIgnoreCase(color)){// 2 iz-1 abajo
                    caminoConectado = true;
                }
                if ((renglon > 0 && renglon < 19) && !columna.equals("A")) {
                    if (getColorCasilla(columna, renglon-1).equalsIgnoreCase("White") &&
                    getColorCasilla(sumaRestaLetras(columna, -1), renglon-1).equalsIgnoreCase("White") &&
                    getColorCasilla(columna, renglon+1).equalsIgnoreCase("White") &&
                    getColorCasilla(sumaRestaLetras(columna, -1), renglon+1).equalsIgnoreCase("White") &&
