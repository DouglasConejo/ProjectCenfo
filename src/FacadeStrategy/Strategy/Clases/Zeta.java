...
public class Zeta extends AbstractPrefa {
    @Override
    ...
    public boolean validateShape(int forma, String columna, int renglon, String color) {
        ...
        switch (forma) {
            case 1 -> {
                if (getColorCasilla(columna, renglon-2).equalsIgnoreCase(color) || //2 arriba
                ...
                getColorCasilla(columna, renglon+2).equalsIgnoreCase(color) || //2abajo
                getColorCasilla(sumaRestaLetras(columna, 1), renglon+2).equalsIgnoreCase(color) || //2 abajo-der
                getColorCasilla(sumaRestaLetras(columna, 2), renglon+1).equalsIgnoreCase(color)){ //1 abajo-2 der
            ...
            case 2 -> {
                ...
                getColorCasilla(sumaRestaLetras(columna, 2), renglon).equalsIgnoreCase(color) || //2der
                getColorCasilla(sumaRestaLetras(columna, 2), renglon-1).equalsIgnoreCase(color) || //2der-arriba
                ...
                getColorCasilla(sumaRestaLetras(columna, -2), renglon-1).equalsIgnoreCase(color) || //abajo-2iz
                getColorCasilla(sumaRestaLetras(columna, -1), renglon-2).equalsIgnoreCase(color)){ //iz-2 abajo
                    caminoConectado = true;
                }
                if ((renglon < 19 && renglon > 0) && (!columna.equals("T") && !columna.equals("A") )) {
